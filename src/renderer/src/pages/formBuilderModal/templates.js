export const TEMPLATES = [
  ...
  {
    id: 'financeiro_banco',
    emoji: '🏦', label: 'Banco', categoria: 'Financeiro',
    descricao: 'Cadastro simples de bancos (código Febraban e nome), base para as Contas Bancárias.',
    nomeTela: 'Banco', nomeTabela: 'banco_001', icone: 'landmark', canvasW: 1200, canvasH: 176,
    campos: [
      { _key:'bk1', nomeCampo:'codigo_febraban', label:'Código Febraban', tipo:'texto', tamanho:3,   obrigatorio:false, sequencial:false, campoBusca:true, valorPadrao:'', largura:20, opcoes:null, x_pos:14,  y_pos:14, w_px:220, h_px:56 },
      { _key:'bk2', nomeCampo:'nome',            label:'Nome',            tipo:'texto', tamanho:120, obrigatorio:true,  sequencial:false, campoBusca:true, valorPadrao:'', largura:80, opcoes:null, x_pos:248, y_pos:14, w_px:938, h_px:56 },
      { _key:'bk3', nomeCampo:'_fav',            label:'Favorito',        tipo:'favorito',   tamanho:0, obrigatorio:false, sequencial:false, campoBusca:false, valorPadrao:'', largura:50,  opcoes:null, x_pos:14,  y_pos:78, w_px:220, h_px:44 },
      { _key:'bk4', nomeCampo:'_ts',             label:'Datas',           tipo:'timestamps',  tamanho:0, obrigatorio:false, sequencial:false, campoBusca:false, valorPadrao:'', largura:100, opcoes:null, x_pos:248, y_pos:78, w_px:938, h_px:56 },
    ],
  },

  {
    id: 'financeiro_conta_bancaria',
    emoji: '💳', label: 'Conta Bancária', categoria: 'Financeiro',
    descricao: 'Contas bancárias da empresa, vinculadas a um Banco cadastrado — usada nos títulos de Contas a Pagar/Receber.',
    nomeTela: 'Conta Bancária', nomeTabela: 'conta_bancaria_001', icone: 'wallet', canvasW: 1200, canvasH: 240,
    campos: [
      { _key:'cb1', nomeCampo:'banco_id', label:'Banco', tipo:'lookup', tamanho:0, obrigatorio:true, sequencial:false, campoBusca:true, valorPadrao:'',
        opcoes:{ lookupTabela:'banco_001', lookupExibir:'nome', lookupCodigo:'codigo_febraban', lookupModo:'select' },
        largura:100, x_pos:14, y_pos:14, w_px:1172, h_px:56 },
      { _key:'cb2', nomeCampo:'agencia', label:'Agência', tipo:'texto', tamanho:20, obrigatorio:false, sequencial:false, campoBusca:false, valorPadrao:'', largura:24, opcoes:null, x_pos:14,  y_pos:78, w_px:283, h_px:56 },
      { _key:'cb3', nomeCampo:'numero',  label:'Número',  tipo:'texto', tamanho:30, obrigatorio:false, sequencial:false, campoBusca:true,  valorPadrao:'', largura:24, opcoes:null, x_pos:311, y_pos:78, w_px:283, h_px:56 },
      { _key:'cb4', nomeCampo:'tipo_conta', label:'Tipo de Conta', tipo:'select', tamanho:20, obrigatorio:false, sequencial:false, campoBusca:false, valorPadrao:'corrente', largura:24, opcoes:[
        {label:'Corrente',valor:'corrente',cor:'#60A5FA'},{label:'Poupança',valor:'poupanca',cor:'#4ADE80'},
      ], x_pos:608, y_pos:78, w_px:283, h_px:56 },
      { _key:'cb5', nomeCampo:'saldo_inicial', label:'Saldo Inicial', tipo:'moeda', tamanho:0, obrigatorio:false, sequencial:false, campoBusca:false, valorPadrao:'', largura:24, opcoes:null, x_pos:905, y_pos:78, w_px:281, h_px:56 },
      { _key:'cb6', nomeCampo:'_fav', label:'Favorito', tipo:'favorito',   tamanho:0, obrigatorio:false, sequencial:false, campoBusca:false, valorPadrao:'', largura:50,  opcoes:null, x_pos:14,  y_pos:142, w_px:220, h_px:44 },
      { _key:'cb7', nomeCampo:'_ts',  label:'Datas',    tipo:'timestamps', tamanho:0, obrigatorio:false, sequencial:false, campoBusca:false, valorPadrao:'', largura:100, opcoes:null, x_pos:248, y_pos:142, w_px:938, h_px:56 },
    ],
  },

  {
    id: 'financeiro_plano_contas',
    emoji: '🗂️', label: 'Plano de Contas', categoria: 'Financeiro',
    descricao: 'Classificação gerencial hierárquica (receita/despesa) usada para categorizar títulos de Contas a Pagar/Receber. Cada conta pode ter uma conta-pai, formando uma árvore.',
    nomeTela: 'Plano de Contas', nomeTabela: 'plano_contas_001', icone: 'list-tree', canvasW: 1200, canvasH: 240,
    campos: [
      { _key:'pc1', nomeCampo:'codigo', label:'Código',  tipo:'texto', tamanho:20,  obrigatorio:false, sequencial:false, campoBusca:true, valorPadrao:'', largura:20, opcoes:null, x_pos:14,  y_pos:14, w_px:220, h_px:56 },
      { _key:'pc2', nomeCampo:'nome',   label:'Nome',    tipo:'texto', tamanho:150, obrigatorio:true,  sequencial:false, campoBusca:true, valorPadrao:'', largura:50, opcoes:null, x_pos:248, y_pos:14, w_px:604, h_px:56 },
      { _key:'pc3', nomeCampo:'tipo',   label:'Tipo',    tipo:'radio', tamanho:20,  obrigatorio:false, sequencial:false, campoBusca:true, valorPadrao:'ambos', largura:30, opcoes:[
        {label:'Receita',valor:'receita',cor:'#4ADE80'},{label:'Despesa',valor:'despesa',cor:'#F87171'},{label:'Ambos',valor:'ambos',cor:'#94A3B8'},
      ], x_pos:866, y_pos:14, w_px:320, h_px:56 },
      { _key:'pc4', nomeCampo:'conta_pai_id', label:'Conta Pai', tipo:'lookup', tamanho:0, obrigatorio:false, sequencial:false, campoBusca:true, valorPadrao:'',
        opcoes:{ lookupTabela:'plano_contas_001', lookupExibir:'nome', lookupCodigo:'codigo', lookupModo:'select' },
        largura:60, x_pos:14, y_pos:78, w_px:704, h_px:56 },
      { _key:'pc5', nomeCampo:'ativo', label:'Ativo', tipo:'booleano', tamanho:0, obrigatorio:false, sequencial:false, campoBusca:false, valorPadrao:'true', largura:40, opcoes:null, x_pos:732, y_pos:78, w_px:454, h_px:56 },
      { _key:'pc6', nomeCampo:'_fav', label:'Favorito', tipo:'favorito',   tamanho:0, obrigatorio:false, sequencial:false, campoBusca:false, valorPadrao:'', largura:50,  opcoes:null, x_pos:14,  y_pos:142, w_px:220, h_px:44 },
      { _key:'pc7', nomeCampo:'_ts',  label:'Datas',    tipo:'timestamps', tamanho:0, obrigatorio:false, sequencial:false, campoBusca:false, valorPadrao:'', largura:100, opcoes:null, x_pos:248, y_pos:142, w_px:938, h_px:56 },
    ],
  },

  {
    id: 'financeiro_contas_pagar',
    emoji: '📤', label: 'Contas a Pagar', categoria: 'Financeiro',
    descricao: 'Títulos a pagar a fornecedores, com parcelamento e baixa (status calculado automaticamente pelas parcelas).',
    nomeTela: 'Contas a Pagar', nomeTabela: 'contas_pagar_001', icone: 'arrow-up-circle', canvasW: 1200, canvasH: 480,
    campos: [
      { _key:'cp1', nomeCampo:'numero_titulo', label:'Nº Título', tipo:'codigo_auto', tamanho:20, obrigatorio:false, sequencial:true, campoBusca:true, valorPadrao:'001', opcoes:{seqChars:5}, largura:14, x_pos:14, y_pos:14, w_px:160, h_px:56 },
      { _key:'cp2', nomeCampo:'fornecedor_id', label:'Fornecedor', tipo:'lookup', tamanho:0, obrigatorio:true, sequencial:false, campoBusca:true, valorPadrao:'',
        opcoes:{ lookupTabela:'entidade_001', lookupExibir:'nome', lookupCodigo:'codigo', lookupModo:'modal', lookupFiltro:{ campo:'papeis', op:'ilike', valor:'F' } },
        largura:56, x_pos:188, y_pos:14, w_px:664, h_px:56 },
      { _key:'cp3', nomeCampo:'status', label:'Status', tipo:'radio', tamanho:20, obrigatorio:false, sequencial:false, campoBusca:true, valorPadrao:'Aberto', largura:30, opcoes:[
        {label:'Aberto',valor:'Aberto',cor:'#60A5FA'},{label:'Parcialmente Pago',valor:'Parcialmente Pago',cor:'#FBD24C'},
        {label:'Pago',valor:'Pago',cor:'#4ADE80'},{label:'Vencido',valor:'Vencido',cor:'#F87171'},{label:'Cancelado',valor:'Cancelado',cor:'#94A3B8'},
      ], x_pos:866, y_pos:14, w_px:320, h_px:56 },
      { _key:'cp4', nomeCampo:'plano_conta_id', label:'Plano de Contas', tipo:'lookup', tamanho:0, obrigatorio:false, sequencial:false, campoBusca:true, valorPadrao:'',
        opcoes:{ lookupTabela:'plano_contas_001', lookupExibir:'nome', lookupCodigo:'codigo', lookupModo:'select' },
        largura:32, x_pos:14, y_pos:78, w_px:380, h_px:56 },
      { _key:'cp5', nomeCampo:'conta_bancaria_id', label:'Conta Bancária', tipo:'lookup', tamanho:0, obrigatorio:false, sequencial:false, campoBusca:true, valorPadrao:'',
        opcoes:{ lookupTabela:'conta_bancaria_001', lookupExibir:'numero', lookupCodigo:'agencia', lookupModo:'select' },
        largura:32, x_pos:408, y_pos:78, w_px:380, h_px:56 },
      { _key:'cp6', nomeCampo:'valor_total', label:'Valor Total', tipo:'moeda', tamanho:0, obrigatorio:true, sequencial:false, campoBusca:false, valorPadrao:'', largura:16, opcoes:null, x_pos:802, y_pos:78, w_px:184, h_px:56 },
      { _key:'cp7', nomeCampo:'dt_emissao', label:'Emissão', tipo:'data', tamanho:0, obrigatorio:false, sequencial:false, campoBusca:false, valorPadrao:'', largura:16, opcoes:null, x_pos:1000, y_pos:78, w_px:186, h_px:56 },
      { _key:'cp8', nomeCampo:'div1', label:'Parcelas', tipo:'divisor', tamanho:0, obrigatorio:false, sequencial:false, campoBusca:false, valorPadrao:'horizontal', largura:100, opcoes:null, x_pos:14, y_pos:142, w_px:1172, h_px:20 },
      { _key:'cp9', nomeCampo:'parcelas', label:'Parcelas', tipo:'sub_grid', tamanho:0, obrigatorio:false, sequencial:false, campoBusca:false, valorPadrao:'',
        opcoes:{
          ...
          subGridCampos:[
            ...
            { nomeCampo:'dt_vencimento',    label:'Vencimento',      tipo:'data',   obrigatorio:true,  ordem:2 },
            { nomeCampo:'status',           label:'Status',          tipo:'radio',  obrigatorio:false, ordem:3, opcoes:{ valores:['Aberta','Parcial','Paga','Vencida','Cancelada'] } },
            { nomeCampo:'dt_pagamento',     label:'Dt. Pagamento',   tipo:'data',   obrigatorio:false, ordem:4 },
            { nomeCampo:'valor_pago',       label:'Valor Pago',      tipo:'moeda',  obrigatorio:false, ordem:5 },
            { nomeCampo:'forma_pagamento',  label:'Forma Pagto.',    tipo:'texto',  obrigatorio:false, ordem:6, tamanho:50 },
          ],
        },
        largura:100, x_pos:14, y_pos:170, w_px:1172, h_px:180 },
      { _key:'cp10', nomeCampo:'observacoes', label:'Observações', tipo:'texto_longo', tamanho:0, obrigatorio:false, sequencial:false, campoBusca:false, valorPadrao:'', largura:60, opcoes:null, x_pos:14, y_pos:364, w_px:704, h_px:80 },
      { _key:'cp11', nomeCampo:'anexo', label:'Anexo (NF/boleto)', tipo:'arquivo', tamanho:0, obrigatorio:false, sequencial:false, campoBusca:false, valorPadrao:'', largura:40, opcoes:null, x_pos:732, y_pos:364, w_px:454, h_px:80 },
      { _key:'cp12', nomeCampo:'_fav', label:'Favorito', tipo:'favorito', tamanho:0, obrigatorio:false, sequencial:false, campoBusca:false, valorPadrao:'', largura:50, opcoes:null, x_pos:14, y_pos:458, w_px:220, h_px:44 },
      { _key:'cp13', nomeCampo:'_ts', label:'Datas', tipo:'timestamps', tamanho:0, obrigatorio:false, sequencial:false, campoBusca:false, valorPadrao:'', largura:100, opcoes:null, x_pos:248, y_pos:458, w_px:938, h_px:56 },
    ],
  },

  {
    id: 'financeiro_contas_receber',
    emoji: '📥', label: 'Contas a Receber', categoria: 'Financeiro',
    descricao: 'Títulos a receber de clientes, com parcelamento e baixa (status calculado automaticamente pelas parcelas).',
    nomeTela: 'Contas a Receber', nomeTabela: 'contas_receber_001', icone: 'arrow-down-circle', canvasW: 1200, canvasH: 480,
    campos: [
      { _key:'cr1', nomeCampo:'numero_titulo', label:'Nº Título', tipo:'codigo_auto', tamanho:20, obrigatorio:false, sequencial:true, campoBusca:true, valorPadrao:'001', opcoes:{seqChars:5}, largura:14, x_pos:14, y_pos:14, w_px:160, h_px:56 },
      { _key:'cr2', nomeCampo:'cliente_id', label:'Cliente', tipo:'lookup', tamanho:0, obrigatorio:true, sequencial:false, campoBusca:true, valorPadrao:'',
        opcoes:{ lookupTabela:'entidade_001', lookupExibir:'nome', lookupCodigo:'codigo', lookupModo:'modal', lookupFiltro:{ campo:'papeis', op:'ilike', valor:'C' } },
        largura:56, x_pos:188, y_pos:14, w_px:664, h_px:56 },
      { _key:'cr3', nomeCampo:'status', label:'Status', tipo:'radio', tamanho:20, obrigatorio:false, sequencial:false, campoBusca:true, valorPadrao:'Aberto', largura:30, opcoes:[
        {label:'Aberto',valor:'Aberto',cor:'#60A5FA'},{label:'Parcialmente Pago',valor:'Parcialmente Pago',cor:'#FBD24C'},
        {label:'Pago',valor:'Pago',cor:'#4ADE80'},{label:'Vencido',valor:'Vencido',cor:'#F87171'},{label:'Cancelado',valor:'Cancelado',cor:'#94A3B8'},
      ], x_pos:866, y_pos:14, w_px:320, h_px:56 },
      { _key:'cr4', nomeCampo:'plano_conta_id', label:'Plano de Contas', tipo:'lookup', tamanho:0, obrigatorio:false, sequencial:false, campoBusca:true, valorPadrao:'',
        opcoes:{ lookupTabela:'plano_contas_001', lookupExibir:'nome', lookupCodigo:'codigo', lookupModo:'select' },
        largura:32, x_pos:14, y_pos:78, w_px:380, h_px:56 },
      { _key:'cr5', nomeCampo:'conta_bancaria_id', label:'Conta Bancária', tipo:'lookup', tamanho:0, obrigatorio:false, sequencial:false, campoBusca:true, valorPadrao:'',
        opcoes:{ lookupTabela:'conta_bancaria_001', lookupExibir:'numero', lookupCodigo:'agencia', lookupModo:'select' },
        largura:32, x_pos:408, y_pos:78, w_px:380, h_px:56 },
      { _key:'cr6', nomeCampo:'valor_total', label:'Valor Total', tipo:'moeda', tamanho:0, obrigatorio:true, sequencial:false, campoBusca:false, valorPadrao:'', largura:16, opcoes:null, x_pos:802, y_pos:78, w_px:184, h_px:56 },
      { _key:'cr7', nomeCampo:'dt_emissao', label:'Emissão', tipo:'data', tamanho:0, obrigatorio:false, sequencial:false, campoBusca:false, valorPadrao:'', largura:16, opcoes:null, x_pos:1000, y_pos:78, w_px:186, h_px:56 },
      { _key:'cr8', nomeCampo:'div1', label:'Parcelas', tipo:'divisor', tamanho:0, obrigatorio:false, sequencial:false, campoBusca:false, valorPadrao:'horizontal', largura:100, opcoes:null, x_pos:14, y_pos:142, w_px:1172, h_px:20 },
      { _key:'cr9', nomeCampo:'parcelas', label:'Parcelas', tipo:'sub_grid', tamanho:0, obrigatorio:false, sequencial:false, campoBusca:false, valorPadrao:'',
        opcoes:{
        ...
        largura:100, x_pos:14, y_pos:170, w_px:1172, h_px:180 },
      { _key:'cr10', nomeCampo:'observacoes', label:'Observações', tipo:'texto_longo', tamanho:0, obrigatorio:false, sequencial:false, campoBusca:false, valorPadrao:'', largura:60, opcoes:null, x_pos:14, y_pos:364, w_px:704, h_px:80 },
      { _key:'cr11', nomeCampo:'anexo', label:'Anexo (NF/recibo)', tipo:'arquivo', tamanho:0, obrigatorio:false, sequencial:false, campoBusca:false, valorPadrao:'', largura:40, opcoes:null, x_pos:732, y_pos:364, w_px:454, h_px:80 },
      { _key:'cr12', nomeCampo:'_fav', label:'Favorito', tipo:'favorito', tamanho:0, obrigatorio:false, sequencial:false, campoBusca:false, valorPadrao:'', largura:50, opcoes:null, x_pos:14, y_pos:458, w_px:220, h_px:44 },
      { _key:'cr13', nomeCampo:'_ts', label:'Datas', tipo:'timestamps', tamanho:0, obrigatorio:false, sequencial:false, campoBusca:false, valorPadrao:'', largura:100, opcoes:null, x_pos:248, y_pos:458, w_px:938, h_px:56 },
    ],
  },
]
